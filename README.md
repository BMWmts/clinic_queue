...
| เอกสาร | สำหรับใคร |
|---|---|
| [LEARNING.md](LEARNING.md) | **มือใหม่** — บทเรียนไล่ลำดับ 15 บท พร้อมแบบฝึกหัด ตั้งแต่ติดตั้งจนเพิ่มฟีเจอร์แรก |
| [docs/](docs/README.md) | คู่มืออธิบายโค้ด **รายไฟล์** (ไทย/English) — ไฟล์นี้ทำอะไร เชื่อมกับใคร |
| [docs/12-api-reference.md](docs/12-api-reference.md) | สรุป endpoint ทั้งหมด + ไฟล์ที่รับผิดชอบ + รหัส error |
| [CLAUDE.md](CLAUDE.md) | ข้อกำหนดต้นทางของระบบ (spec) |
