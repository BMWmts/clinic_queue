...
### ภาคผนวก ง — รายการภาพประกอบที่ควรถ่ายลงเล่ม

🔲 **[ผู้เขียนถ่ายภาพหน้าจอเอง]**

| # | ภาพ | หน้าจอ |
|---|---|---|
| 1 | หน้าเข้าสู่ระบบ | `/login` |
| 2 | หน้าจอคิวหน้างานพร้อมสถานะเรียลไทม์ | `/queue` |
| 3 | กล่องรับคิว walk-in | `/queue` (กดปุ่มรับคิว Walk-in) |
| 4 | ข้อความปฏิเสธเมื่อคิวเต็ม | `/queue` |
| 5 | ตารางแพทย์รายวัน | `/calendar` |
| 6 | กล่องจองคิวที่แสดงเฉพาะเวลาว่างจริง | `/calendar` |
| 7 | หน้าค้นหาคนไข้ | `/patients` |
| 8 | ประวัติคนไข้และโน้ต | `/patients/{id}` |
| 9 | หน้าจัดการแพทย์และตารางออกตรวจ | `/doctors/{id}` |
| 10 | รายงานสรุปและ heatmap ช่วงเวลาหนาแน่น | `/reports` |
| 11 | โครงสร้างฐานข้อมูลใน pgAdmin | pgAdmin |
| 12 | ผลการทดสอบอัตโนมัติ 92 กรณี | Terminal |
