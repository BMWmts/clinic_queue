...
### 3.8 การออกแบบด้านฐานข้อมูลขั้นสูงและการจัดการทรานแซกชัน
...
#### 3.8.2 ข้อจำกัดความถูกต้องที่บังคับใช้ในระดับฐานข้อมูล
...
#### 3.8.3 การวิเคราะห์ปัญหาภาวะแข่งขัน (Race Condition Analysis)
...
#### 3.8.4 กลไกจัดการทรานแซกชันที่ใช้ในระบบ
...
#### 3.8.5 การป้องกันแบบหลายชั้น (Defence in Depth)
...
#### 3.8.6 ทางเลือกอื่นที่พิจารณาและเหตุผลในการตัดสินใจ
...
#### 3.8.7 ฟีเจอร์ฐานข้อมูลขั้นสูงอื่นที่นำมาใช้
...
#### 3.8.8 ประเด็นที่มักถูกตั้งคำถามเกี่ยวกับการออกแบบนี้
...
**ข้อจำกัดด้านฐานข้อมูล** (สืบเนื่องจากการออกแบบในหัวข้อ 3.8)
...
6. ทดสอบภาวะพร้อมกันเชิงปริมาณ โดยยิงคำขอจองช่วงเวลาเดียวกันพร้อมกันจำนวนมาก
   แล้ววัดว่ามีคำขอสำเร็จเพียงรายการเดียวและที่เหลือถูกปฏิเสธทั้งหมด เพื่อยืนยันการออกแบบในหัวข้อ 3.8 เชิงประจักษ์
